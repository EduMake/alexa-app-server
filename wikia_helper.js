...
var fs = require("fs");
function WikiaHelper(sWikia, oListWikiaCatergories) {
  this.wikia = new Wikia(sWikia);
  this.oListWikiaCatergories = {};
  if(typeof oListWikiaCatergories !== 'undefined'){
    this.oListWikiaCatergories = oListWikiaCatergories;
  }
}

WikiaHelper.prototype.getIntentionCatergories = function(sSubject) {
  if(this.hasOwnProperty("oListWikiaCatergories") && this.oListWikiaCatergories.hasOwnProperty(sSubject)) {
    return this.oListWikiaCatergories[sSubject];
  }
  return "";
};
